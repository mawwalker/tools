...
# Ask for server name (sni)
read -p "Enter server name/SNI (default: cdn-dynmedia-1.microsoft.com, 
Choose one of 
Microsoft:
...
m.media-amazon.com
player.live-video.net): " server_name
server_name=${server_name:-cdn-dynmedia-1.microsoft.com}
